...
class BAPackageCollection: UIViewController {
    ...
    var PackageCollection = String()
    var packageCollection = [PackageCollections]()
    ...
    func getDashoard() {
        ...
        let params =  "strXml=<NeoFitnes><Credential><UserName>\(userName)</UserName><Password>\(password)</Password></Credential><PackageWiseCollection><PackageCollection><BranchId>\(branchId)</BranchId><StartDate>\(self.startDate)</StartDate><EndDate>\(self.endDate)</EndDate></PackageCollection></PackageWiseCollection></NeoFitnes>"
        ...
        let todosEndpoint: String = "http://mobile.rightsoft.in/NeoFitnessService.asmx/GetPackageWiseCollectionReport"
...
extension BAPackageCollection: XMLParserDelegate {
...
extension BAPackageCollection: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        self.countLabel.text = "Count: \(self.packageCollection.count)"
